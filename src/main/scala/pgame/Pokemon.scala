...
object Attack extends Enumeration {
  val ELEMENTAL_BOLT, SURF, THUNDERBOLT, ELEMENTAL_PYLON, ELEMENTAL_RING,
      ...
      ELEMENTAL_BLAST, FLAME_PUNCH, FIRE_SPIN, FLAME_WHEEL, SWORD_ATTACK,
      SWORD_THROWER, FLAMING_BEAK, FLAME_ROLL, PSYCHIC, PSYCHIC_BOLT, BODY_SLAM= Value
}

object PokemonType extends Enumeration {
  val FIRE, WATER, STEEL, DRAGON, ELECTRIC, ELEMENTAL, ICE, FLYING, FIGHTING, PSYCHIC= Value
}